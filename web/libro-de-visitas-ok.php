...
<html lang="es">
	...
	<body>
		...
		<div class="contenedor">
			...
			<h3 id="contacto-ok">Su publicación ha sido enviada exitósamente. La misma será procesada por el administrador para luego publicarla de manera oficial en la Web.</h3>
		</div>
